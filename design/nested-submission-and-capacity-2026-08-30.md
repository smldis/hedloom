...
read `docs/guide/refusals.md` and `run/ONTOLOME.md`. The example this walk
produced, `examples/live_source.py`, lands as its own change — it is worth
having whether or not any of the scheduling work below is ever built.
